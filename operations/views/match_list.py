...
from operations.permissions import ExcludeClubViewerAccessMixin, MatchScopedQuerysetMixin

from .helpers import get_selectable_clubs


class MatchListView(LoginRequiredMixin, ExcludeClubViewerAccessMixin, MatchScopedQuerysetMixin, ListView):
    model = Match
