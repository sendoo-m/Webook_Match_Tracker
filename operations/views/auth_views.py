...
from core.permissions import is_club_manager
...
class HtmxLoginView(LoginView):
    ...
    3. A "Club Manager" account lands on the Club Dashboard instead of the
       default LOGIN_REDIRECT_URL (Operations Dashboard) - that page is
       blocked for this group (see
       operations.permissions.ExcludeClubManagerAccessMixin), so sending
    ...
    def get_default_redirect_url(self):
        if is_club_manager(self.request.user):
